...
namespace UniqueHabits.Data.Migrations
{
    ...
    [Migration("20240513223956_EnableNotificationsColumnForAppUser")]
    partial class EnableNotificationsColumnForAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniqueHabits.Domain.Aggregates.Implementation", b =>
                {
                    ...
                    b.Property<string>("CustomizationCategory")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid?>("PreviousImplementationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PreviousImplementationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("UniqueHabits.Domain.Aggregates.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UniqueHabits.Domain.Aggregates.Implementation", b =>
                {
                    ...
                    b.HasOne("UniqueHabits.Domain.Aggregates.Implementation", "PreviousImplementation")
                        .WithOne()
