...
namespace UniqueHabits.Data.Migrations
{
    ...
    [Migration("20240429233448_AddCreatedByUserIdColumnForHabits")]
    partial class AddCreatedByUserIdColumnForHabits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniqueHabits.Domain.Aggregates.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UniqueHabits.Domain.Aggregates.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniqueHabits.Domain.Aggregates.Habit", b =>
                {
                    b.HasOne("UniqueHabits.Domain.Aggregates.AppUser", "CreatedBy")
                        .WithMany()
